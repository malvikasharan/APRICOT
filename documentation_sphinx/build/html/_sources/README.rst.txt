...
``$ cd home   $ apricot -h`` NOTE: Follow this to ensure that the most
latest APRICOT repository exists in your docker container:
...
``$ apricot default -i {UniProt IDs} -kw {Domain keywords}`` Example
analysis:
