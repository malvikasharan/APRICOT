...
**3. Get the supporting data required for running your queries**
  ...
  Be aware that the supporting data is a large file: ~15 G compressed, and ~50 G uncompressed.
...
APRICOT_analysis
  ...
  You can check `APRICOT_analysis_summary.csv` file for the quick overview of the analysis.
