...
In the GitHub repository we have provided a test folder named [tests](https://github.com/malvikasharan/APRICOT/tree/master/tests), to allow the basic system testing using [test datasets](https://github.com/malvikasharan/APRICOT/tree/master/tests/demo_files_small), which does not require installation of third party tools.
